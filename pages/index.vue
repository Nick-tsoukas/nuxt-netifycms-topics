<template>
  <div>
    ...
    <section class="bg-white dark:bg-gray-800 mb-24 mt-24">
        ...
        <div class="lg:flex items-center">
          ...
          <div class="mt-8 lg:mt-0 lg:w-1/2">
            <div class="flex items-center justify-center lg:justify-start">
              <div class="max-w-lg">
                <img class="w-full h-64 object-cover object-center rounded-md shadow"
          ...
          <div class="lg:w-1/2">
            ...
            <p class="text-gray-500 dark:text-gray-400 lg:max-w-md mt-4">
              Hi I am jane , software engineer <a class="text-indigo-600 dark:text-indigo-400 font-bold"
                href="#">@BakaTeam</a> , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in sed non
              alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi ex veniam consequuntur id, maiores beatae ipsa
              omnis aliquam?
            </p>
